...
namespace SmartCommerce.Common
{
	public static partial class Constants
	{
		...
		public const string MANAGER_COMPONENT_NAME_HEADER = "Header";
		/// <summary>Manager component name: Footer</summary>
		public const string MANAGER_COMPONENT_NAME_FOOTER = "Footer";
		/// <summary>Manager component name: Style sheet</summary>
		...
		public const string MANAGER_COMPONENT_NAME_NAVBAR = "NavBar";
		/// <summary>Manager component name: Theme setting</summary>
		public const string MANAGER_COMPONENT_NAME_THEME_SETTING = "ThemeSetting";
		/// <summary>Manager component name: Notification</summary>
		...
		public const string MANAGER_COMPONENT_NAME_CREATED_BY_BADGE = "CreatedByBadge";
		#endregion
