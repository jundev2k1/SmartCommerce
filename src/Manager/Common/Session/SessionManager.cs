...
namespace SmartCommerce.Manager.Common.Session
{
	public sealed class SessionManager : SessionManagerBase
	{
		...
		/// <summary>Operator Permission List</summary>
		public string[] OperatorPermissionList
		{
			get { return this.OperatorPermission.Split(',', StringSplitOptions.RemoveEmptyEntries); }
			set { Set(Constants.SESSION_KEY_OPERATOR_PERMISSION, value); }
		}
